...
class _CircularChartState extends State<CircularChart> {
  ...
  Widget build(BuildContext context) {
    if (widget.title == 'Thu nhập' && incomeData.isEmpty) {
      return SizedBox(
        width: double.infinity,
        height: 130,
        child: Opacity(
            opacity: 0.2,
            child: Image.asset('assets/images/ChartIllustrator.png')),
      );
    } else if (widget.title == 'Chi tiêu' && expenseData.isEmpty) {
      return Padding(
        ...
        child: SfCircularChart(
            ...
            series: <CircularSeries>[
              ...
              DoughnutSeries<ChartData, String>(
                  dataSource:
                      widget.title == 'Thu nhập' ? incomeData : expenseData,
